...
## DATA CLEANING
In an SQL Database, column names with spaces are not recognized unlike in Excel. Hence, I had to rename the columns with spaces for using the code below.
...
NB: I just spiced it up here by formatting it as currency to input the dollar sign but when I want to do serious calculations, I avoid doing this because it affect ordering and calculations at times.
...
The Query below was used to find out the Month **Dotty Strutley** was Absent
